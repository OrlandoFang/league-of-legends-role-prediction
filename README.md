...
Problem Type: multiclass classification (total of 5 different values: top,jng,mid,bot,and sup)
...
From the confusion matrix, I can see that most roles are predicted accurately, and predictions for jng and sup are extremely accurate.
